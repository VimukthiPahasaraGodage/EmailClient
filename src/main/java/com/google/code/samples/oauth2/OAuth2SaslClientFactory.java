...
/**
 * A SaslClientFactory that returns instances of com.google.code.samples.oauth2.OAuth2SaslClient.
 *
 * <p>Only the "XOAUTH2" mechanism is supported. The {@code callbackHandler} is
 * passed to the com.google.code.samples.oauth2.OAuth2SaslClient. Other parameters are ignored.
 */
